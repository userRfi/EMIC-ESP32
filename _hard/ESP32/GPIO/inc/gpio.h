/*****************************************************************************
 * @file    gpio.h
 * @brief   ESP32 GPIO HAL Macros for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    01/31/2026
 *
 * @details Hardware Abstraction Layer macros for GPIO control on ESP32.
 *          Uses ESP-IDF GPIO driver for reliable operation.
 *****************************************************************************/
 ...
 *
 * Usage:
 *   HAL_GPIO_PinSet(LED, 1);  // Turn LED on
 *   HAL_GPIO_PinSet(LED, 0);  // Turn LED off
 */
 ...
 *
 * Usage:
 *   int state = HAL_GPIO_PinGet(BUTTON);
 */
 ...
 * @param type Interrupt type (GPIO_INT_RISING, GPIO_INT_FALLING, etc.)
 */
...
/**
 * @brief Check if pin is input-only (GPIO 34-39)
 */
