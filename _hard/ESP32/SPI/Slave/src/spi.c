 ...
 * @brief   ESP32 SPI.{host}. Slave Implementation for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    01/31/2026
 *
 * @details SPI Slave implementation using ESP-IDF spi_slave driver.
 *****************************************************************************/
...
static const char *TAG = "SPI.{host}._Slave";
