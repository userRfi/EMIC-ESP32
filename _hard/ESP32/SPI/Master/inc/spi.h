/*****************************************************************************
 * @file    SPI.{host}..h
 * @brief   ESP32 SPI.{host}. Master Header for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    01/31/2026
 *
 * @details SPI Master interface for SPI.{host}. (HSPI=2, VSPI=3)
 *          Clock speed: .{speed}. Hz
 *****************************************************************************/

#ifndef ESP32_SPI.{host}._MASTER_H
#define ESP32_SPI.{host}._MASTER_H
...
#if .{host}. == 2
    /* HSPI defaults */
    #define SPI.{host}._MOSI_DEFAULT    13
    #define SPI.{host}._MISO_DEFAULT    12
    #define SPI.{host}._CLK_DEFAULT     14
    #define SPI.{host}._CS_DEFAULT      15
#elif .{host}. == 3
    /* VSPI defaults */
    #define SPI.{host}._MOSI_DEFAULT    23
    #define SPI.{host}._MISO_DEFAULT    19
    #define SPI.{host}._CLK_DEFAULT     18
    #define SPI.{host}._CS_DEFAULT      5
#endif
...
#endif /* ESP32_SPI.{host}._MASTER_H */
