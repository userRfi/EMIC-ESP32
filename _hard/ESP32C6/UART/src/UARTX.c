/*****************************************************************************
 * @file    UART.{port}..c
 * @brief   ESP32-C6 UART.{port}. Implementation for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    02/07/2026
 *
 * @details UART implementation for ESP32-C6 using ESP-IDF uart_driver.
 *****************************************************************************/
...
static const char *TAG = "UART.{port}._C6";

/*============================================================================
 * ESP32-C6 Default Pin Configuration
 *============================================================================*/

#if .{port}. == 0
    /* UART0: Default TX=GPIO16, RX=GPIO17 */
    #define UART_TX_PIN     16
    #define UART_RX_PIN     17
#elif .{port}. == 1
    /* UART1: Default TX=GPIO4, RX=GPIO5 */
    #define UART_TX_PIN     4
    #define UART_RX_PIN     5
#else
    #error "ESP32-C6 only supports UART0 and UART1"
#endif
