/*****************************************************************************
 * @file    I2C.{port}..h
 * @brief   ESP32-C6 I2C.{port}. Master Header for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    02/07/2026
 *
 * @details I2C Master interface for ESP32-C6.
 *          ESP32-C6 has only I2C0 available.
 *          Default speed: .{speed}. Hz
 *****************************************************************************/

#ifndef ESP32C6_I2C.{port}._H
#define ESP32C6_I2C.{port}._H
...
/* ESP32-C6 Default I2C0 pins */
#define I2C.{port}._SDA_DEFAULT    6
#define I2C.{port}._SCL_DEFAULT    7
