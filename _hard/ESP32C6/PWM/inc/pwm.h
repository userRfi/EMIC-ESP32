/*****************************************************************************
 * @file    pwm.h
 * @brief   ESP32-C6 PWM (LEDC) Header for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    02/07/2026
 *
 * @details PWM interface for ESP32-C6 using LEDC peripheral.
 *          6 channels total (all low-speed, no high-speed on C6).
 *****************************************************************************/

#ifndef ESP32C6_PWM_H
#define ESP32C6_PWM_H
...
/*============================================================================
 * Configuration (ESP32-C6 specific)
 *============================================================================*/

/* ESP32-C6 has only 6 LEDC channels, all low-speed */
#define PWM_CHANNEL_COUNT       6
#define PWM_HS_CHANNELS         0   /* No high-speed on C6 */
...
#define PWM_MAX_RESOLUTION      14  /* C6 supports up to 14-bit */

/* Speed mode (C6 only has low speed) */
