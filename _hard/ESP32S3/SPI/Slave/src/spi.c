 ...
 * @brief   ESP32-S3 SPI.{host}. Slave Implementation for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    02/07/2026
 *
 * @details SPI Slave implementation for ESP32-S3 using ESP-IDF spi_slave driver.
...
static const char *TAG = "SPI.{host}._Slave_S3";
