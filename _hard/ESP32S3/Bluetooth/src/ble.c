/*****************************************************************************
 * @file    ble.c
 * @brief   ESP32-S3 BLE Implementation for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    02/07/2026
 *
 * @details BLE 5.0 implementation for ESP32-S3 using NimBLE stack.
 *****************************************************************************/
...
static char ble_device_name[BLE_DEVICE_NAME_MAX + 1] = "ESP32-S3";
...
void BLE_init(void)
{
    ...
    ESP_LOGI(TAG, "BLE initialized (ESP32-S3, BLE 5.0)");
}
