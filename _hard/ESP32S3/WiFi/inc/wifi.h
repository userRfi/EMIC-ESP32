/*****************************************************************************
 * @file    wifi.h
 * @brief   ESP32-S3 WiFi Header for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    02/07/2026
 *
 * @details WiFi interface for ESP32-S3 supporting Station and Access Point modes.
 *          WiFi 4 (802.11n) support.
 *****************************************************************************/

#ifndef ESP32S3_WIFI_H
#define ESP32S3_WIFI_H
