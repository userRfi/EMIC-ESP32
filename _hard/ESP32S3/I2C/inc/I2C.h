/*****************************************************************************
 * @file    I2C.{port}..h
 * @brief   ESP32-S3 I2C.{port}. Master Header for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    02/07/2026
 *
 * @details I2C Master interface for ESP32-S3.
 *          ESP32-S3 has I2C0 and I2C1 available.
 *          Default speed: .{speed}. Hz
 *****************************************************************************/

#ifndef ESP32S3_I2C.{port}._H
#define ESP32S3_I2C.{port}._H
...
#else
#define I2C.{port}._SDA_DEFAULT    17
#define I2C.{port}._SCL_DEFAULT    18
#endif
