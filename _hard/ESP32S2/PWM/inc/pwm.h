/*****************************************************************************
 * @file    pwm.h
 * @brief   ESP32-S2 PWM (LEDC) Header for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    02/07/2026
 *
 * @details PWM interface for ESP32-S2 using LEDC peripheral.
 *          8 channels total (all low-speed, no high-speed on S2).
 *****************************************************************************/

#ifndef ESP32S2_PWM_H
#define ESP32S2_PWM_H
...
/*============================================================================
 * Configuration (ESP32-S2 specific)
 *============================================================================*/

/* ESP32-S2 has 8 LEDC channels, all low-speed */
#define PWM_CHANNEL_COUNT       8
#define PWM_HS_CHANNELS         0   /* No high-speed on S2 */
...
#define PWM_MAX_RESOLUTION      14  /* S2 supports up to 14-bit */

/* Speed mode (S2 only has low speed) */
