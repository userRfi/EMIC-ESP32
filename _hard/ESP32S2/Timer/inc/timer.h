/*****************************************************************************
 * @file    timer.h
 * @brief   ESP32-S2 Timer Header for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    02/07/2026
 *
 * @details Timer interface for ESP32-S2. 4 hardware timers (2 groups x 2).
 *****************************************************************************/

#ifndef ESP32S2_TIMER_H
#define ESP32S2_TIMER_H
...
#define ESP32S2_HW_TIMER_COUNT  4
