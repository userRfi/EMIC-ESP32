/*****************************************************************************
 * @file    UART.{port}..c
 * @brief   ESP32-S2 UART.{port}. Implementation for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    02/07/2026
 *
 * @details UART implementation for ESP32-S2 using ESP-IDF uart_driver.
 *****************************************************************************/
...
static const char *TAG = "UART.{port}._S2";

/*============================================================================
 * ESP32-S2 Default Pin Configuration
 *============================================================================*/
...
#else
    #error "ESP32-S2 only supports UART0 and UART1"
#endif
