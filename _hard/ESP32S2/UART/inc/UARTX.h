/*****************************************************************************
 * @file    UART.{port}..h
 * @brief   ESP32-S2 UART.{port}. Header for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    02/07/2026
 *
 * @details UART.{port}. interface for ESP32-S2.
 *          Default baud: .{baud}., Buffer size: .{BufferSize}. bytes
 *****************************************************************************/

#ifndef ESP32S2_UART.{port}._H
#define ESP32S2_UART.{port}._H
