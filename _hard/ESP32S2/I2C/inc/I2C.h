/*****************************************************************************
 * @file    I2C.{port}..h
 * @brief   ESP32-S2 I2C.{port}. Master Header for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    02/07/2026
 *
 * @details I2C Master interface for ESP32-S2.
 *          ESP32-S2 has I2C0 and I2C1 available.
 *          Default speed: .{speed}. Hz
 *****************************************************************************/

#ifndef ESP32S2_I2C.{port}._H
#define ESP32S2_I2C.{port}._H
...
/* ESP32-S2 Default I2C pins */
#if .{port}. == 0
#define I2C.{port}._SDA_DEFAULT    8
#define I2C.{port}._SCL_DEFAULT    9
#else
#define I2C.{port}._SDA_DEFAULT    3
#define I2C.{port}._SCL_DEFAULT    4
#endif
