/*****************************************************************************
 * @file    SPI.{host}..h
 * @brief   ESP32-C3 SPI.{host}. Master Header for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    02/07/2026
 *
 * @details SPI Master interface for ESP32-C3 SPI2
 *          ESP32-C3 only has SPI2 available for general use.
 *          Clock speed: .{speed}. Hz
 *****************************************************************************/

#ifndef ESP32C3_SPI.{host}._MASTER_H
#define ESP32C3_SPI.{host}._MASTER_H
...
#endif /* ESP32C3_SPI.{host}._MASTER_H */
