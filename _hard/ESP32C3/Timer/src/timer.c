/*****************************************************************************
 * @file    timer.c
 * @brief   ESP32-C3 Timer Implementation for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    02/07/2026
 *
 * @details Timer implementation for ESP32-C3 using esp_timer and hardware timers.
 *          ESP32-C3 has only 2 hardware timers (2 groups x 1 timer each).
 *****************************************************************************/
...
static const char *TAG = "Timer_C3";
...
/*============================================================================
 * Hardware Timer State - ESP32-C3 has 2 groups x 1 timer
 *============================================================================*/
...
/*============================================================================
 * Hardware Timer Implementation - ESP32-C3 specific (1 timer per group)
 *============================================================================*/
...
{
    /* ESP32-C3 only has timer 0 in each group */
    if (group < 0 || group > 1 || timer != 0) {
        ESP_LOGE(TAG, "Invalid timer: ESP32-C3 only has timer 0 in each group");
        return false;
    }
