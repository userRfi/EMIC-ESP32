/*****************************************************************************
 * @file    UART.{port}..h
 * @brief   ESP32-C3 UART.{port}. Header for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    02/01/2026
 *
 * @details UART.{port}. interface for ESP32-C3 (RISC-V).
 *          Default baud: .{baud}., Buffer size: .{BufferSize}. bytes
 *****************************************************************************/

#ifndef ESP32C3_UART.{port}._H
#define ESP32C3_UART.{port}._H
