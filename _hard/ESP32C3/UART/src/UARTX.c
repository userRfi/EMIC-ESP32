/*****************************************************************************
 * @file    UART.{port}..c
 * @brief   ESP32-C3 UART.{port}. Implementation for EMIC SDK
 * @author  EMIC Team
 * @version v1.0.0
 * @date    02/01/2026
 *
 * @details UART implementation for ESP32-C3 using ESP-IDF uart_driver.
 *****************************************************************************/
...
/*============================================================================
 * ESP32-C3 Default Pin Configuration
 *============================================================================*/

#if .{port}. == 0
    /* UART0: Default TX=GPIO21, RX=GPIO20 */
    #define UART_TX_PIN     21
    #define UART_RX_PIN     20
#elif .{port}. == 1
    /* UART1: Default TX=GPIO4, RX=GPIO5 (JTAG pins, reconfigurable) */
    #define UART_TX_PIN     4
    #define UART_RX_PIN     5
#else
    #error "ESP32-C3 only supports UART0 and UART1"
#endif
